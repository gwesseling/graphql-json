...
"GraphQL JSON" is a powerful tool that helps you create a GraphQL schema using JSON. With an input schema based on the GraphQL type API, it feels familiar to most users.

This package provides full support for TypeScript-typed JSON schemas for your GraphQL server, enabling you to take advantage of strong typing and avoid errors. At the same time, it preserves the flexibility that GraphQL offers, allowing you to shape your schema to your liking.

The main goal of this package is to simplify the process of constructing a GraphQL schema. It helps you eliminate unnecessary clutter, making it easier to understand and modify your schema. This way, you can reduce errors and build a reliable GraphQL API without the downsides of the GraphQL Types API or the GraphQL Schema Language.
...
For a complete input example, please refer to the [example](#example) chapter below. This chapter contains a complete JSON input schema, as well as the resulting output generated by the "GraphQL JSON".
